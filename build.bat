...
javac -d bin -cp "bin;lib\*" src\game\engine\*.java src\game\entities\*.java src\game\app\*.java src\Custom_DSA\Lists\*.java src\Custom_DSA\Nodes\*.java src\Custom_DSA\Stack_Queue\*.java src\Custom_DSA\Graph\*.java
